...
contract ENSOpsForkTest is Test {
    ...
    function _op1() internal {
        ...
        bytes memory callData = hex"095ea7b30000000000000000000000001ba8603da702602a8657980e825a6daa03dee93a00000000000000000000000000000000000000000000000000000045d964b800";
        vm.prank(SENDER);
    ...
    function _op4() internal {
        address target = USDC_ADDR;
        bytes memory callData = hex"095ea7b30000000000000000000000001d65c6d3ad39d454ea8f682c49ae7744706ea96d000000000000000000000000000000000000000000000000000004a36fb03800";
        vm.prank(SENDER);
        (bool success, ) = address(target).call(callData);
    ...
    function _op5() internal {
        ...
        bytes memory callData = hex"";
        vm.prank(SENDER);
        (bool success, ) = address(target).call(callData);
    ...
    function testOps() public {
        console.log("USDC allowance to USDCx before approval", usdc.allowance(SENDER, USDCX_ADDR));
        _op1();
        console.log("USDC allowance to USDCx after approval", usdc.allowance(SENDER, USDCX_ADDR));
        ...
        uint256 expectedAutoWrapAllowance = 5_100_000 * 1e6;
